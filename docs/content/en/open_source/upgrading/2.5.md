---
title: "Upgrading to ExposureX Version 2.5.x"
toc_hide: true
weight: -20211208
...
to the new authorization as described in https://documentation.exposurex.com/getting_started/upgrading/#authorization.
