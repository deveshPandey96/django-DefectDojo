---
title: "Upgrading to ExposureX Version 1.7.0"
toc_hide: true
weight: -20200700
...
Upgrading to ExposureX Version 1.5.0
-------------------------------------

**What\'s New:**

-   Updated UI with a new ExposureX logo, default colors and CSS.
...
-   New Contextual menus throughout ExposureX and shortcuts to new
...
-   ExposureX 2.0 API with Swagger support
...
2.  Edit the settings.py file which can be found in
    `django-ExposureX/dojo/settings/settings.py`. Copy in the rest
...
\[settings\](<https://github.com/ExposureX/django-ExposureX/blob/master/dojo/settings/settings.dist.py>)
