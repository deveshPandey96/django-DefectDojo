...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('url', models.URLField(help_text='For more information how to configure Jira, read the ExposureX documentation.', max_length=2000, verbose_name='JIRA URL')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('false_positive_history', models.BooleanField(default=False, help_text='ExposureX will automatically mark the finding as a false positive if the finding has been previously marked as a false positive.')),
                ('url_prefix', models.CharField(blank=True, default='', help_text="URL prefix if ExposureX is installed in it's own virtual subdirectory.", max_length=300)),
        ...
        migrations.AlterField(
            model_name='risk_acceptance',
            name='accepted_by',
            field=models.CharField(blank=True, default=None, help_text='The person that accepts the risk, can be outside of ExposureX.', max_length=200, null=True, verbose_name='Accepted By'),
        ),
        migrations.AlterField(
            model_name='risk_acceptance',
        ...
        migrations.AlterField(
            model_name='risk_acceptance',
            name='owner',
            field=models.ForeignKey(help_text='User in ExposureX owning this acceptance. Only the owner and staff users can edit the risk acceptance.', on_delete=django.db.models.deletion.CASCADE, to='dojo.dojo_user'),
        ),
        migrations.AlterField(
            model_name='risk_acceptance',
            name='path',
